...
test('Embassy Visa', async({page}) => {
    ...
    await selectors.booleanOptions(page, "general.need_multiple_entry_visa", "boolean-No")
    ...
    await selectors.booleanOptions(page, "applicant.0.own_state_triage", "boolean-Yes")
    ...
    await selectors.booleanOptions(page ,"applicant.0.previously_visited", "boolean-No")
    await selectors.booleanOptions(page ,"applicant.0.current_visas", "boolean-No")
    await selectors.booleanOptions(page ,"applicant.0.refused_visa", "boolean-No")
    await expect(next_btn).toBeEnabled()
    await next_btn.click()
    ...
    await selectors.booleanOptions(page, "applicant.0.other_document", "boolean-No")
