...
test('Individual subscription purchase', async ({ page }) => {
  ...
  await page.waitForURL("**/thailand/apply-now/passport-details/0?splitversion=friction--jupiter")
  await appFunctions.step_2(page, continue_sidebar)
  await page.waitForURL("**/thailand/apply-now/address-details/0?splitversion=friction--jupiter")
  await appFunctions.step_3c(page, continue_sidebar)
  await page.waitForURL("**/thailand/apply-now/additional-info/0?splitversion=friction--jupiter")
  ...
  await continue_sidebar.click()
  await page.waitForURL("**/thailand/apply-now/checkout?splitversion=friction--jupiter")
  ...
  // Place free order 
 await page.goto(deploy_url + 'thailand/apply-now')
 await appFunctions.autofillExisting(page, "thailand/apply-now/edit-traveler/0?splitversion=friction--jupiter", false, true)
 await page.waitForURL("**/thailand/apply-now/traveler-review?splitversion=friction--jupiter")
 await continue_sidebar.click()
 await page.waitForURL("**/thailand/apply-now/contact-details?splitversion=friction--jupiter")
  await continue_sidebar.click() 
