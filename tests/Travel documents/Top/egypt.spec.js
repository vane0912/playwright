...
test('Egypt eVisa', async ({ page }) => {
  ...
  await appFunctions.autofillExisting(page, "egypt/apply-now/edit-traveler/0?splitversion=friction--jupiter")
  await page.waitForURL("**/egypt/apply-now/traveler-review?splitversion=friction--jupiter")
  const continue_sidebar = page.getByRole("button").getByText("Continue")
  await continue_sidebar.click()
  await page.waitForURL("**/egypt/apply-now/contact-details?splitversion=friction--jupiter")
  await continue_sidebar.click() 
