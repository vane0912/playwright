...
test('United States ESTA', async ({ page }) => {
  ...
  await appFunctions.autofillExisting(page, "usa/apply-now/edit-traveler/0?splitversion=friction--jupiter", "au")
  await page.waitForURL("**/usa/apply-now/traveler-review?splitversion=friction--jupiter")
  const continue_sidebar = page.getByRole("button").getByText("Continue")
  await continue_sidebar.click()
  await page.waitForURL("**/usa/apply-now/contact-details?splitversion=friction--jupiter")
  await continue_sidebar.click() 
