...
test('Curacao Immigration Card + Passenger Locator Card', async ({ page }) => {
  ...
  await appFunctions.autofillExisting(page, "curacao/apply-now/edit-traveler/0?splitversion=friction--jupiter")
  await page.waitForURL("**/curacao/apply-now/traveler-review?splitversion=friction--jupiter")
  const continue_sidebar = page.getByRole("button").getByText("Continue")
  await continue_sidebar.click()
  await page.waitForURL("**/curacao/apply-now/contact-details?splitversion=friction--jupiter")
  await continue_sidebar.click() 
