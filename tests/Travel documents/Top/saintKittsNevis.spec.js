...
test.fixme('Saint Kitts and Nevis ETA ', async ({ page }) => {
  test.slow()
  await appFunctions.step_1(page,"au", "saint-kitts-and-nevis/apply-now")
  const continue_sidebar = page.locator('id=btnContinueSidebar')

  await appFunctions.step_2(page,continue_sidebar)
  await page.waitForURL("**/saint-kitts-and-nevis/apply-now#step=step_3c")
  
  await appFunctions.step_3c(page,continue_sidebar)
  await page.waitForURL("**/saint-kitts-and-nevis/apply-now#step=review")
