...
test.fixme('Saint Kitts and Nevis ETA ', async ({ page }) => {
  ...
  await appFunctions.autofillExisting(page, "saint-kitts-and-nevis/apply-now/edit-traveler/0?splitversion=friction--jupiter")
  await page.waitForURL("**/saint-kitts-and-nevis/apply-now/traveler-review?splitversion=friction--jupiter")
  const continue_sidebar = page.getByRole("button").getByText("Continue")
  await continue_sidebar.click()
  await page.waitForURL("**/saint-kitts-and-nevis/apply-now/contact-details?splitversion=friction--jupiter")
  await continue_sidebar.click() 
