...
test('Philippines eArrival Card', async ({ page }) => {
  ...
  await appFunctions.autofillExisting(page, "philippines/apply-now/edit-traveler/0?splitversion=friction--jupiter")
  await page.waitForURL("**/philippines/apply-now/traveler-review?splitversion=friction--jupiter")
  const continue_sidebar = page.getByRole("button").getByText("Continue")
  await continue_sidebar.click()
  await page.waitForURL("**/philippines/apply-now/contact-details?splitversion=friction--jupiter")
  await continue_sidebar.click() 
