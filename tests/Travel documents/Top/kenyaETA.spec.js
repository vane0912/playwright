...
test('Kenya Eta', async ({ page }) => {
  ...
  await selectors.booleanOptions(page, "general.mode_of_transport", "boolean-Land")
  await selectors.dropdownSelector(page, "general.arrival_city", "dropdown-general.arrival_city", "kwale","Lungalunga Border - Kwale")
  await selectors.booleanOptions(page, "general.departure_mode_transport", "boolean-Land")
  ...
  await selectors.booleanOptions(page, "applicant.0.bahamas_disclaimer", "boolean-No")
  await expect(next_btn).toBeEnabled()
  await next_btn.click()
